...
-- 4. Política adicional para chat_messages: bloqueia acesso direto sem session_id
CREATE POLICY "Restrict direct database access to chat messages" 
ON public.chat_messages 
FOR ALL 
RESTRICTIVE
USING (true)
...
-- 5. Funções administrativas para analytics (bypass seguro do RLS)
