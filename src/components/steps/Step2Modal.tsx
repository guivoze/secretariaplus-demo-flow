...
export const Step2Modal = () => {
  ...
  const WhatsAppBackground = () => <div className="chat-preview-container">
      ...
      <div className="chat-messages flex-1 p-4 space-y-3" style={{
        paddingBottom: 80
      }}>
        {showMessage && <div className="flex justify-start">
            {messageAnimated ? <div className="max-w-[80%] p-3 rounded-2xl shadow-sm bg-white text-black rounded-bl-md">
            ...
            duration: 0.3
          }} onAnimationComplete={() => setMessageAnimated(true)} className="max-w-[80%] p-3 rounded-2xl shadow-sm bg-white text-black rounded-bl-md">
                <p className="text-sm">{initialMessage.text}</p>
                <div className="flex items-center gap-1 mt-1 justify-start">
                  <span className="text-xs text-gray-500">{initialMessage.timestamp}</span>
                </div>
      ...
      <div className="chat-inputbar bg-[#f0f0f0] border-t" style={{
        bottom: 0
      }}>
        <div className="mx-4 flex items-center gap-3 bg-white rounded-full px-4 py-2 shadow-sm">
          <input type="text" placeholder="Digite uma mensagem" className="flex-1 outline-none bg-transparent" style={{
            fontSize: '16px'
          }} disabled />
  ...
  return <div className="h-screen relative overflow-hidden">
      ...
      duration: 1,
      ease: "easeInOut"
    }} className="fixed inset-0 pointer-events-none z-20" style={{
        ...
        duration: 0.3
          ...
          delay: 0.1
              ...
              delay: 0.3
                  ...
                  <p className="text-content-medium leading-relaxed">Em instantes, você poderá simular uma conversa entre clínica e paciente.</p>
